...
var (
	defaultCB *CircuitBreaker[bool]
	customCB  *CircuitBreaker[bool]
)
...
func init() {
	defaultCB = NewCircuitBreaker[bool]()
	customCB = newCustom()
}
...
func TestNewCircuitBreaker(t *testing.T) {
	defaultCB := NewCircuitBreaker[bool]()
	assert.Equal(t, "unspecified-breaker", defaultCB.name)
...
func TestTwoStepCircuitBreaker(t *testing.T) {
	tscb := NewTwoStepCircuitBreaker[bool](WithName("tscb"))
...
func TestCustomIsSuccessful(t *testing.T) {
	...
	cb := NewCircuitBreaker[bool](WithIsSuccessful(isSuccessful))
